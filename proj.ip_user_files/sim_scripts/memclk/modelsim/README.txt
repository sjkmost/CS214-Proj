...
#
# Generated by export_simulation on Wed May 24 22:01:16 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './memclk.sh' script.
...
./memclk.sh -noclean_files

For more information on the script, please type './memclk.sh -help'.
