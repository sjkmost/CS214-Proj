...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir D:/Class/CS214/CS214-Proj/proj.runs/RAM_synth_1 -new_name RAM -ip [get_ips RAM]]
...
if { [catch {
  file copy -force D:/Class/CS214/CS214-Proj/proj.runs/RAM_synth_1/RAM.dcp D:/Class/CS214/CS214-Proj/proj.srcs/sources_1/ip/RAM/RAM.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub D:/Class/CS214/CS214-Proj/proj.srcs/sources_1/ip/RAM/RAM_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub D:/Class/CS214/CS214-Proj/proj.srcs/sources_1/ip/RAM/RAM_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim D:/Class/CS214/CS214-Proj/proj.srcs/sources_1/ip/RAM/RAM_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim D:/Class/CS214/CS214-Proj/proj.srcs/sources_1/ip/RAM/RAM_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force D:/Class/CS214/CS214-Proj/proj.runs/RAM_synth_1/RAM_stub.v D:/Class/CS214/CS214-Proj/proj.srcs/sources_1/ip/RAM/RAM_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/Class/CS214/CS214-Proj/proj.runs/RAM_synth_1/RAM_stub.vhdl D:/Class/CS214/CS214-Proj/proj.srcs/sources_1/ip/RAM/RAM_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/Class/CS214/CS214-Proj/proj.runs/RAM_synth_1/RAM_sim_netlist.v D:/Class/CS214/CS214-Proj/proj.srcs/sources_1/ip/RAM/RAM_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/Class/CS214/CS214-Proj/proj.runs/RAM_synth_1/RAM_sim_netlist.vhdl D:/Class/CS214/CS214-Proj/proj.srcs/sources_1/ip/RAM/RAM_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir D:/Class/CS214/CS214-Proj/proj.ip_user_files/ip/RAM]} {
  catch { 
    file copy -force D:/Class/CS214/CS214-Proj/proj.srcs/sources_1/ip/RAM/RAM_stub.v D:/Class/CS214/CS214-Proj/proj.ip_user_files/ip/RAM
  }
}

if {[file isdir D:/Class/CS214/CS214-Proj/proj.ip_user_files/ip/RAM]} {
  catch { 
    file copy -force D:/Class/CS214/CS214-Proj/proj.srcs/sources_1/ip/RAM/RAM_stub.vhdl D:/Class/CS214/CS214-Proj/proj.ip_user_files/ip/RAM
  }
}
