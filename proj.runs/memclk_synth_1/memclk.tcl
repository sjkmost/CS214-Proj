...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir D:/lhy/semester2-2/computer_organization/lab/CS214-Proj/proj.runs/memclk_synth_1 -new_name memclk -ip [get_ips memclk]]

if { $cached_ip eq {} } {

synth_design -top memclk -part xc7a100tfgg484-1 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix memclk_ memclk.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ memclk_stub.v
 lappend ipCachedFiles memclk_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ memclk_stub.vhdl
 lappend ipCachedFiles memclk_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ memclk_sim_netlist.v
 lappend ipCachedFiles memclk_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ memclk_sim_netlist.vhdl
 lappend ipCachedFiles memclk_sim_netlist.vhdl

 config_ip_cache -add -dcp memclk.dcp -move_files $ipCachedFiles -use_project_ipc -ip [get_ips memclk]
}

rename_ref -prefix_all memclk_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef memclk.dcp
